...
const CATEGORY_KEYWORDS = {
  food: ["кофе", "обед", "ужин", "завтрак", "еда", "продукты", "ресторан", "кафе", "перекус"],
  transport: ["такси", "автобус", "метро", "бензин", "транспорт", "маршрутка", "поезд", "самолет", "самолёт", "билет"],
  home: ["аренда", "квартира", "жкх", "счет", "счёт", "интернет", "коммуналка"],
  fun: ["кино", "бар", "вечеринка", "развлечения", "игра", "концерт"],
